...
## **Анализ логических противоречий и недочётов в ТЗ**
...
❗ **Проблема:** Требования противоречат друг другу. Согласно пункту 2, количество товара не может быть меньше 1, а удаление осуществляется только через отдельную кнопку. В то же время пункт 9 допускает уменьшение количества до 0, что автоматически приводит к удалению товара.
...
❗ **Проблема:** Это прямое логическое противоречие в бизнес-логике ценообразования. Цена не может одновременно быть зафиксированной и автоматически обновляться при изменении в каталоге.
...
❗ **Проблема:** В требованиях не описан порядок проверки ограничений и приоритеты лимитов. Неясно:
...
## **Исправленная версия требований к корзине**
...
3. Должна ли цена товара пересчитываться при оформлении заказа или оставаться зафиксированной до момента оплаты?  
4. Должна ли корзина сохраняться между пользовательскими сессиями?  
5. Нужно ли учитывать содержимое корзины при показе рекламных товаров?
